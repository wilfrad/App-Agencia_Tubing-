...
public class Consulta {
    ...
    private String formatoCadena (String[] entrada) {
        
        Stream<String> tempEntrada = Arrays.asList(entrada).stream();
        String cadenaFormateada;
        
        cadenaFormateada = tempEntrada.collect(Collectors.joining(","));
